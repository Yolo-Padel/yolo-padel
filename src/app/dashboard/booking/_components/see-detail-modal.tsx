...
export function SeeBookingDetails({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle className='space-y-2 font-bold text-2xl'>
                    ...
                    <DialogClose className="absolute right-3.5 top-3.5 inline-flex items-center justify-center rounded-full bg-[#C3D223] p-2.5 text-black hover:bg-[#A9B920] border mt-0">
                    </DialogClose>
