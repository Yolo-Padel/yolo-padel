...
export function HeroSection() {
  return (
    <div className="relative z-20 flex flex-col gap-10 w-full">
      {/* Main Content */}
      <div className="flex-1 mx-auto lg:max-w-[1200px] p-6 lg:p-0">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
          ...
          <div className="flex justify-center w-full">
            <div className="w-full bg-white rounded-4xl p-6 lg:max-h-[calc(100vh-12rem)] overflow-y-auto overflow-x-hidden">
